...
import {Slate, Editable, withReact, useSlate, ReactEditor, useSelected} from "slate-react";
...
export default function Create (props) {
    ...
    return (
        <Container id={'create-container'} maxWidth={'sm'} style={{marginTop:14}}>
    ...
    return (
        <Container
            ...
            <div contentEditable={false}>
                <img src={props.element.src} style={{maxHeight:window.innerHeight/3, border: selected ? '4px solid #EBEFEE' : null}}
                />
            </div>
            {props.children}
        </Container>
